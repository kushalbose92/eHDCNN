...
train_data_1=pd.read_csv(r"C:\Users\SAGAR GHOSH\OneDrive\Desktop\Dissertation\EHDCNN\Simulation\arythmia\mini_train_data_1.csv")
test_data_1=pd.read_csv(r"C:\Users\SAGAR GHOSH\OneDrive\Desktop\Dissertation\EHDCNN\Simulation\arythmia\mini_test_data_1.csv")
...
x_train_n=train_data_1.iloc[:,:30].values
y_train_n=train_data_1.iloc[:,30:].values
x_test_n=test_data_1.iloc[:,:30].values
y_test_n=test_data_1.iloc[:,30:].values
